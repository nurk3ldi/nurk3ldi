...
const nurkeldi = {
  ...
  focus: ["AI-powered products", "responsive interfaces", "reliable services"],
  experience: "1+ year",
  completedProjects: "20+",
  currentlyBuilding: ["AIReca"],
};
```

I build fast, clean and memorable digital products across frontend, backend and data.  
My goal is to turn product requirements into reliable applications with clear architecture and thoughtful details.

- Building **AIReca**, an AI receptionist for customer communication and appointment booking
- Studying **Software Engineering** at Astana IT University College
- Open to full-stack, product engineering and AI-focused opportunities
...
<img src="https://skillicons.dev/icons?i=react,js,html,css,nodejs,python,postgres,mongodb,docker,git,github,vite,postman,figma&theme=dark" alt="Technology stack" />
...
| JavaScript | REST API | MongoDB | Git & GitHub |
| HTML5 / CSS3 | Python | Data modelling | Vite |
| Responsive UI | Full-stack architecture | Structured workflows | Postman / Figma |
...
### `AIReca`
> AI receptionist that communicates with customers, books appointments and helps businesses manage requests in one place.

`React` · `Python` · `PostgreSQL` · `AI workflows`
...
**Let’s build something useful, reliable and memorable.**
